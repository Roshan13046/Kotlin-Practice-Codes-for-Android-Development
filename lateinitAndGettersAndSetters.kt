...
//    var roshanCar = Car("Toyota","Innova Crysta",300)
//    roshanCar.maxSpeed = -350
//    roshanCar.maxSpeed = 350
//
//}
//
...
fun main(args: Array<String>) {
    ...
    //challenge 2 
    var phone7 = MobilePhone("Oreo","ViVo","SeamSy 123",40)
    phone7.chargeBattery(40)
}
...
class MobilePhone(osName: String = "jelly beans",brand:String ="Samsung", model:String = "J7"){
    ...
    constructor(osName : String,brand:String,model:String,batteryLeft : Int) : this(osName,brand,model){
        this.batteryLeft = batteryLeft 
    }
    
    //member function
    fun chargeBattery(chargeBatteryBy : Int ){
        println("The ${this.brand} phone battery before charging was $batteryLeft ,charged now by $chargeBatteryBy and current batteryLeft is ${batteryLeft + chargeBatteryBy} ")
        this.batteryLeft +=  chargeBatteryBy
    }
}